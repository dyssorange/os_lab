...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	62a50513          	addi	a0,a0,1578 # 800660 <main+0x102>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	62a50513          	addi	a0,a0,1578 # 800680 <main+0x122>
...
exit(int error_code) {
  ...
  800136:	55650513          	addi	a0,a0,1366 # 800688 <main+0x12a>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800192:	51278793          	addi	a5,a5,1298 # 8006a0 <main+0x142>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001ee:	4eaa8a93          	addi	s5,s5,1258 # 8006d4 <main+0x176>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  8001f6:	6feb8b93          	addi	s7,s7,1790 # 8008f0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  80044c:	28860613          	addi	a2,a2,648 # 8006d0 <main+0x172>
  ...
  80045e:	26660613          	addi	a2,a2,614 # 8006c0 <main+0x162>
  ...
  800470:	24c40413          	addi	s0,s0,588 # 8006b8 <main+0x15a>
  ...
  8004fa:	1c240413          	addi	s0,s0,450 # 8006b8 <main+0x15a>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  800510:	1ada0a13          	addi	s4,s4,429 # 8006b9 <main+0x15b>
...
int main(void)
{
  80055e:	7179                	addi	sp,sp,-48
  800560:	f022                	sd	s0,32(sp)
  800562:	ec26                	sd	s1,24(sp)
  800564:	e84a                	sd	s2,16(sp)
  800566:	e44e                	sd	s3,8(sp)
    // parent writes initial values
    buf[0] = 0x1;
  800568:	00001497          	auipc	s1,0x1
  80056c:	a9848493          	addi	s1,s1,-1384 # 801000 <buf>
  800570:	4985                	li	s3,1
    buf[4096] = 0x2;
  800572:	00002417          	auipc	s0,0x2
  800576:	a8e40413          	addi	s0,s0,-1394 # 802000 <buf+0x1000>
  80057a:	4909                	li	s2,2
{
  80057c:	f406                	sd	ra,40(sp)
    buf[0] = 0x1;
  80057e:	01348023          	sb	s3,0(s1)
    buf[4096] = 0x2;
  800582:	01240023          	sb	s2,0(s0)

    int pid = fork();
  800586:	bbbff0ef          	jal	ra,800140 <fork>
    if (pid < 0)
  80058a:	08054163          	bltz	a0,80060c <main+0xae>
    {
        panic("fork failed\n");
    }
    if (pid == 0)
  80058e:	e905                	bnez	a0,8005be <main+0x60>
    {
        // child: see parent's data, then modify (should trigger COW)
        assert(buf[0] == 0x1 && buf[4096] == 0x2);
  800590:	0004c783          	lbu	a5,0(s1)
  800594:	01379663          	bne	a5,s3,8005a0 <main+0x42>
  800598:	00044783          	lbu	a5,0(s0)
  80059c:	07278063          	beq	a5,s2,8005fc <main+0x9e>
  8005a0:	00000697          	auipc	a3,0x0
  8005a4:	43868693          	addi	a3,a3,1080 # 8009d8 <error_string+0xe8>
  8005a8:	00000617          	auipc	a2,0x0
  8005ac:	45860613          	addi	a2,a2,1112 # 800a00 <error_string+0x110>
  8005b0:	45d5                	li	a1,21
  8005b2:	00000517          	auipc	a0,0x0
  8005b6:	41650513          	addi	a0,a0,1046 # 8009c8 <error_string+0xd8>
  8005ba:	a6dff0ef          	jal	ra,800026 <__panic>
        buf[4096] = 0x4;
        exit(0);
    }
    ...
    assert(wait() == 0);
  8005be:	b85ff0ef          	jal	ra,800142 <wait>
  8005c2:	ed3d                	bnez	a0,800640 <main+0xe2>
    assert(buf[0] == 0x1 && buf[4096] == 0x2);
  8005c4:	0004c783          	lbu	a5,0(s1)
  8005c8:	05379d63          	bne	a5,s3,800622 <main+0xc4>
  8005cc:	00044783          	lbu	a5,0(s0)
  8005d0:	05279963          	bne	a5,s2,800622 <main+0xc4>

    // parent can still write afterwards
    buf[0] = 0x5;
  8005d4:	4795                	li	a5,5
  8005d6:	00f48023          	sb	a5,0(s1)
    buf[4096] = 0x6;

    cprintf("cowtest passed.\n");
  8005da:	00000517          	auipc	a0,0x0
  8005de:	44e50513          	addi	a0,a0,1102 # 800a28 <error_string+0x138>
    buf[4096] = 0x6;
  8005e2:	4799                	li	a5,6
  8005e4:	00f40023          	sb	a5,0(s0)
    cprintf("cowtest passed.\n");
  8005e8:	abbff0ef          	jal	ra,8000a2 <cprintf>
    return 0;
}
  8005ec:	70a2                	ld	ra,40(sp)
  8005ee:	7402                	ld	s0,32(sp)
  8005f0:	64e2                	ld	s1,24(sp)
  8005f2:	6942                	ld	s2,16(sp)
  8005f4:	69a2                	ld	s3,8(sp)
  8005f6:	4501                	li	a0,0
  8005f8:	6145                	addi	sp,sp,48
  8005fa:	8082                	ret
        buf[0] = 0x3;
  8005fc:	478d                	li	a5,3
  8005fe:	00f48023          	sb	a5,0(s1)
        buf[4096] = 0x4;
  800602:	4791                	li	a5,4
  800604:	00f40023          	sb	a5,0(s0)
        exit(0);
  800608:	b23ff0ef          	jal	ra,80012a <exit>
        panic("fork failed\n");
  80060c:	00000617          	auipc	a2,0x0
  800610:	3ac60613          	addi	a2,a2,940 # 8009b8 <error_string+0xc8>
  800614:	45c1                	li	a1,16
  800616:	00000517          	auipc	a0,0x0
  80061a:	3b250513          	addi	a0,a0,946 # 8009c8 <error_string+0xd8>
  80061e:	a09ff0ef          	jal	ra,800026 <__panic>
    assert(buf[0] == 0x1 && buf[4096] == 0x2);
  800622:	00000697          	auipc	a3,0x0
  800626:	3b668693          	addi	a3,a3,950 # 8009d8 <error_string+0xe8>
  80062a:	00000617          	auipc	a2,0x0
  80062e:	3d660613          	addi	a2,a2,982 # 800a00 <error_string+0x110>
  800632:	45f5                	li	a1,29
  800634:	00000517          	auipc	a0,0x0
  800638:	39450513          	addi	a0,a0,916 # 8009c8 <error_string+0xd8>
  80063c:	9ebff0ef          	jal	ra,800026 <__panic>
    assert(wait() == 0);
  800640:	00000697          	auipc	a3,0x0
  800644:	3d868693          	addi	a3,a3,984 # 800a18 <error_string+0x128>
  800648:	00000617          	auipc	a2,0x0
  80064c:	3b860613          	addi	a2,a2,952 # 800a00 <error_string+0x110>
  800650:	45f1                	li	a1,28
  800652:	00000517          	auipc	a0,0x0
  800656:	37650513          	addi	a0,a0,886 # 8009c8 <error_string+0xd8>
  80065a:	9cdff0ef          	jal	ra,800026 <__panic>
